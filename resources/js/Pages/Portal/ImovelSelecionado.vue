    ...
    <v-col cols="10">
                ...
                <span v-if="user">
                    <span v-if="imoveis.solicitacao_imoveis.length > 0">
                            <span v-for="(solicitacao) in imoveis.solicitacao_imoveis" :key="solicitacao.id" >
                                            
                                <span v-if="solicitacao.user_marca_visita ==user.id && solicitacao.imoveis_id==imoveis.id">
                                            <v-chip  outlined
                                            title="estado do imóvel" class="white--text" :color="getcor(solicitacao.estado_imoveis_id)" v-if="user.id == solicitacao.user_marca_visita">
                                             ...
                                             <v-chip v-else-if="!solicitacao.user_marca_visita ==user.id && !solicitacao.imoveis_id==imoveis.id"  outlined
                                            title="estado do imóvel" class="white--text" :color="getcor(imoveis.estado_imoveis_id)">
                                               
                                        <span v-if="imoveis.estado_imoveis_id == 1" class="mdi mdi-archive-lock-open "></span>
                                        <span v-if="imoveis.estado_imoveis_id == 2" class="mdi mdi-archive-remove"></span>
                                        <span v-if="imoveis.estado_imoveis_id == 5" class="mdi mdi-archive-refresh"></span>
                    ...
                    <v-chip v-else outlined title="estado do imóvel" class="white--text" :color="getcor(imoveis.estado_imoveis_id)">
           ...
           <v-btn v-else  class="ml-auto" color="#4527A0" dense outlined @click="marcarVisita()">
