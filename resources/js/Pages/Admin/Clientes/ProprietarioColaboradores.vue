                ...
                <v-col cols="12" md="12" class="pa-0  mt-15 indigo">
                    <v-card-actions>
                        <span class=" white--text text-bold text-h5">
                            Proprietários & Colaboradores ({{ prorietarios_colaboradores.length }})
                        </span>
                    ...
                    <v-hover v-slot="{ hover }">
                        ...
                        :style="'white-space:nowrap; padding:0;max-width: 100%; position:relative;top:10px; ; border-radius: 10px 80px 10px 60px;'">
                            ...
                            <v-card-text>
                                ...
                                <div > <span class="font-weight-bold indigo--text">Função:</span> {{ item.tipo_user.designacao }}
                                </div>
                            </v-card-text>
...
export default {
    ...
    props: ["prorietarios_colaboradores",],
    components: {
        Cliente
    },
    data: () => ({
    ...
    methods: {
        ...
        pesqueisar(){
            axios
                ...
                .then((response) => {
                      this.prorietarios_colaboradores = response.data.prorietarios_colaboradores
                })
                .catch(() => {
    ...
    /*         location.reload(); */
        ...
        emitirRelatoriosProcesso() {
            window.open(
                "/clientes/emitir-relatorios-proprietarios-colaboradores"
            )
        },
        ...
        carregarDialogEditarpessoa(item) {
            this.editedIndex = this.prorietarios_colaboradores.indexOf(item);
