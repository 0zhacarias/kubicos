            ...
            <div id="invoice">
                <h6>Imóvel anunciado
                    <span class="spas">Total de
                        Registros:{{ count($eminitirAnuncioPDF) }}
                    </span>
                </h6>
            </div>
                   ...
                   @if (count($eminitirAnuncioPDF))
                            @foreach ($eminitirAnuncioPDF as $imovel)
                                <tr>
                                    ...
                                    <td><span class="subtitulos">{{ $imovel->condicaoImoveis->designacao }}</span></td>
                                    {{-- <td><span class="subtitulos">{{ $imovel->actividadeImoveis[0]->operacaoImoveis->designacao }}</span></td> --}}
                            ...
                            <tr>
                                ...
                                <td colspan="7" class="line"><span class="subtitulos">{!! $imovel->descricao !!}</span></td>
